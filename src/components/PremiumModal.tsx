...
export const PremiumModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/90 backdrop-blur-xl overflow-y-auto">
      <div className="relative w-full max-w-lg bg-gradient-to-b from-[#1c0a32] via-[#120622] to-[#090312] border border-orange-600/40 rounded-3xl p-5 sm:p-6 shadow-[0_0_50px_rgba(168,85,247,0.3)] overflow-hidden max-h-[92vh] flex flex-col">
        {/* Floating Close */}
        <button
          onClick={() => {
            setShowPaystackCheckout(false);
        ...
        {!showPaystackCheckout ? (
          <div className="flex-1 overflow-y-auto custom-scrollbar space-y-5">
            ...
            <div className="text-center pt-2">
              <div className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full bg-gradient-to-r from-orange-500/20 to-orange-600/20 border border-orange-400/40 text-orange-300 text-xs font-black uppercase tracking-widest mb-2 shadow-sm">
                ...
                return (
                  <div
                    ...
                    className={`relative p-3.5 rounded-2xl border cursor-pointer transition-all flex flex-col justify-between ${
                      isSelected
                        ? 'bg-gradient-to-b from-[#2e104f] to-[#1a0730] border-orange-400/80 shadow-[0_0_20px_rgba(234,179,8,0.25)] scale-[1.02]'
                        : 'bg-[#140726]/80 border-orange-950 hover:border-orange-800'
                    }`}
                  >
                    {plan.badge && (
                      <span className="absolute -top-2.5 left-1/2 -translate-x-1/2 whitespace-nowrap text-[8px] font-black uppercase bg-gradient-to-r from-orange-500 to-orange-600 text-black px-2 py-0.5 rounded-full shadow-sm">
                        {plan.badge}
                      </span>
                    )}
                    ...
                    <div className="mt-2 pt-2 border-t border-orange-950 flex items-center justify-center">
                      <div
            ...
            {/* Benefits Checklist */}
            <div className="p-4 rounded-2xl bg-[#1e0c29] border border-orange-900/40 space-y-2.5">
              <span className="text-xs font-bold uppercase tracking-wider text-orange-300 block flex items-center space-x-1.5">
              ...
              <div className="space-y-2 text-xs text-neutral-200">
                {selectedPlan.features.map((feat, i) => (
                  <div key={i} className="flex items-start space-x-2">
                    <div className="w-4 h-4 rounded-full bg-orange-500/20 text-orange-300 flex items-center justify-center shrink-0 mt-0.5 border border-orange-500/40">
            ...
            <button
              ...
              className="w-full py-3.5 px-4 rounded-2xl bg-gradient-to-r from-orange-400 via-orange-600 to-orange-600 text-black font-black text-sm shadow-[0_0_25px_rgba(234,179,8,0.4)] hover:brightness-110 transition-all flex items-center justify-center space-x-2"
          ...
          <div className="space-y-5 pt-2 animate-fadeIn">
            <div className="text-center pb-3 border-b border-orange-950">
              <div className="inline-block p-2 rounded-xl bg-orange-950 border border-orange-700/50 text-orange-300 mb-1">
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                ...
                className={`p-3 rounded-xl border text-center transition-all ${
                  payMethod === 'card'
                    ? 'bg-orange-900/80 border-orange-400 text-white'
                    : 'bg-[#1e0c29] border-orange-950 text-neutral-400'
                }`}
              >
                <CreditCard className="w-4 h-4 mx-auto mb-1 text-orange-300" />
              ...
              >
                <Building className="w-4 h-4 mx-auto mb-1 text-orange-300" />
              ...
              >
                <Smartphone className="w-4 h-4 mx-auto mb-1 text-orange-300" />
            ...
            {payMethod === 'card' && (
              <div className="p-4 rounded-2xl bg-[#1e0c29] border border-orange-900/50 space-y-2.5 text-xs">
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2.5 rounded-xl bg-[#0e041b] border border-orange-950 text-white font-mono"
                    readOnly
                  />
                </div>
            ...
            {payMethod === 'transfer' && (
              <div className="p-4 rounded-2xl bg-[#1e0c29] border border-orange-900/50 space-y-2 text-xs">
                <span className="text-[10px] text-orange-400 font-bold block uppercase">
                  Pay to Dynamic Wema/Paystack Account
                </span>
                <div className="p-3 rounded-xl bg-[#0e041b] border border-orange-950 flex justify-between items-center">
                  <div>
                  ...
                  <span className="text-xs text-orange-300 font-bold">Wema Bank</span>
                </div>
              </div>
            )}

            {payMethod === 'ussd' && (
              <div className="p-4 rounded-2xl bg-[#1e0c29] border border-orange-900/50 text-xs text-center space-y-1">
                <span className="text-neutral-300">Dial below on your registered SIM:</span>
                <p className="text-base font-mono font-bold text-orange-300">*737*50*1500*819#</p>
              </div>
            )}
