    ...
    <div className="mx-auto flex w-full max-w-6xl min-w-0 flex-1 flex-col space-y-5 overflow-y-auto px-3 pb-24 pt-4 custom-scrollbar sm:px-5 sm:pt-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-black font-display text-white tracking-tight flex items-center space-x-2">
            ...
            <span className="rounded-full bg-white/[0.06] px-2.5 py-1 text-sm font-bold text-pink-100 ring-1 ring-white/10">
        ...
        {!isPremium && (
          <button
            ...
            className="uoa-quiet-button flex items-center space-x-1.5 rounded-xl px-3 py-1.5 text-xs font-extrabold text-orange-200 transition-colors hover:bg-white/10"
          >
      ...
      {!isPremium && (
        <div className="uoa-surface relative overflow-hidden rounded-2xl p-4">
          <div className="absolute -right-6 -bottom-6 w-24 h-24 bg-orange-600/30 rounded-full blur-2xl pointer-events-none" />
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-[11px] text-orange-200/80 mt-0.5 leading-relaxed">
          ...
          >
            ...
            {!isPremium && (
              <div className="absolute inset-0 flex flex-col items-center justify-center p-3 text-center z-10">
                <div className="w-10 h-10 rounded-full bg-black/70 border border-orange-500/50 flex items-center justify-center text-orange-300 mb-2 backdrop-blur-md shadow-lg">
                  <Lock className="w-5 h-5" />
                </div>
                <span className="text-xs font-black text-white drop-shadow">
                  {profile.level} Student
                </span>
                <span className="text-[10px] text-orange-300 drop-shadow truncate max-w-[120px]">
                  {profile.department}
                </span>
              </div>
            )}
            ...
            {isPremium ? (
              <div className="relative z-10 p-3 flex flex-col justify-end space-y-1.5">
                ...
                <div className="text-[10px] text-orange-300 truncate">
              ...
              >
                <span className="text-[10px] font-bold text-orange-300 flex items-center justify-center space-x-1">
