...
export const SafetyCenterView: React.FC<{
  ...
  return (
    <div className="w-full max-w-6xl mx-auto min-w-0 flex-1 flex flex-col p-3 sm:p-4 space-y-5 overflow-y-auto custom-scrollbar pb-24">
      {/* Hero Header */}
      <div className="p-5 rounded-3xl bg-gradient-to-br from-[#1d0933] via-[#130622] to-[#090312] border border-orange-800/40 shadow-xl relative overflow-hidden">
        <div className="absolute top-0 right-0 w-32 h-32 bg-orange-600/20 rounded-full blur-3xl" />
        <div className="flex items-center space-x-2.5 mb-2">
          <div className="p-2 rounded-xl bg-orange-950/80 border border-orange-500/50 text-orange-300">
        ...
        <div className="grid grid-cols-2 gap-2 mt-4">
          <button
            ...
            className="p-3 rounded-2xl bg-orange-950/60 border border-orange-800/40 text-left hover:bg-orange-900/60 transition-all flex items-center justify-between group"
          >
            <div>
              <span className="text-xs font-bold text-white block">Community Rules</span>
              <span className="text-[10px] text-orange-300">Zero-tolerance policies</span>
            </div>
          ...
          >
            <div>
              ...
              <span className="text-[10px] text-orange-300">Consent & Health guides</span>
            </div>
            <ChevronRight className="w-4 h-4 text-orange-400 group-hover:translate-x-0.5 transition-transform" />
          </button>
        </div>
      ...
      <div className="space-y-3">
        <h3 className="text-xs font-bold uppercase tracking-wider text-orange-400 flex items-center space-x-1.5">
        ...
        {CAMPUS_SAFETY_RULES.map((rule, idx) => (
          <div
            key={idx}
            className="p-4 rounded-2xl bg-[#130722] border border-orange-950 space-y-1.5 shadow-sm"
          >
            <div className="flex items-center space-x-2">
              <span className="w-5 h-5 rounded-full bg-orange-900/80 text-orange-300 text-[10px] font-bold flex items-center justify-center border border-orange-700/50 shrink-0">
                {idx + 1}
              </span>
      ...
      <div className="space-y-3">
        ...
        <div className="p-4 rounded-2xl bg-[#1c0b25] border border-orange-900/40 text-xs text-neutral-300 leading-relaxed">
