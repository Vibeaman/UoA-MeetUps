    ...
    <div className="w-full max-w-6xl mx-auto min-w-0 flex-1 flex flex-col p-3 sm:p-4 space-y-4 overflow-y-auto custom-scrollbar pb-24">
      ...
      <div className="flex items-center space-x-2.5 pb-2 border-b border-purple-950/80">
        ...
        <div>
          ...
          <p className="text-[11px] text-purple-300">Practical guides for UniAbuja students</p>
        </div>
      </div>
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-full text-xs font-semibold whitespace-nowrap transition-all ${
              activeCategory === idx
                ...
                : 'bg-[#130722] text-neutral-400 border border-purple-950 hover:text-white'
            }`}
          >
            {cat.category}
          </button>
      ...
      <div className="space-y-3 flex-1">
        <div className="p-4 rounded-2xl bg-gradient-to-br from-[#180b2a] to-[#10051d] border border-purple-800/40">
          ...
          <div className="space-y-2.5 mt-3">
            {DATING_AND_HEALTH_TIPS[activeCategory].tips.map((tip, i) => (
              <div key={i} className="flex items-start space-x-2.5 text-xs text-neutral-200">
                <div className="w-4 h-4 rounded-full bg-purple-900/80 text-purple-300 text-[10px] font-bold flex items-center justify-center shrink-0 mt-0.5 border border-purple-700/50">
        ...
        <div className="p-4 rounded-2xl bg-[#120620] border border-purple-950">
